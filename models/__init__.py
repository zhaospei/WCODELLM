...
def load_model_and_tokenizer(model_name='opt-13b', device='cuda:0', load_in_8bit=False, **kwargs):
    ...
    if model_name.startswith('facebook/opt-'):
        return _load_pretrained_model(model_name, device, load_in_8bit, **kwargs), _load_pretrained_tokenizer(model_name)
    return _load_pretrained_model(model_name, device, load_in_8bit, **kwargs), _load_pretrained_tokenizer(model_name)
